    ...
    const app = {
        ...
        rGetPImage(img, name = "D", type = "Curso") {
            if (!img || img === 'stripped_for_cache' || img === 'null' || img === '' || img === 'default_product.png') {
                ...
                if (type === 'Ebook') {
                    // Ícone de Livro Aberto com Bordas Arredondadas (Premium)
                ...
                const svg = `
                    <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 24 24" fill="none" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                        <defs>
